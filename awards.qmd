...
honors <- tribble(
  ...
  2025, "Elm Markert '25", "Highest Honors", "Towards a 16S rRNA Sequence Analysis Pipeline: Exploring Statistical Methods for Taxonomic Assignment", NA, "Kaitlyn Cook", "Luce Ward",
  2025, "Tillie Slosser '25", "Highest Honors", "Spatiotemporal Interpolation of Wildfire Smoke-Derived PM2.5 using Deep Neural Networks", NA, "Scott LaCombe", "",
