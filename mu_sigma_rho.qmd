...
[Mu Sigma Rho](http://www.stat.purdue.edu/~mccabe/msr/) is the national statistics honor society, and the [Boston Chapter of the American Statistical Association](https://community.amstat.org/bostonchapter/home) oversees [nominations](https://community.amstat.org/bostonchapter/awards/new-page) from Smith each spring.
...
archive %>%
  write_rds(file = here::here("data/mu_sigma_rho.rda"))
```

```{r read-archive}
archive <- read_rds(here::here("data/mu_sigma_rho.rda"))
```
