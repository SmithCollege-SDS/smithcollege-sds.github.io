...
Resources for instructors for [Albert Y. Kim](http://rudeboybert.rbind.io/){target="_blank"} & [Johanna Hardin's](https://research.pomona.edu/johardin/){target="_blank"} *"Playing the whole game": A data collection and analysis exercise with Google Calendar* paper.
...
* Data Collection
  - Experience with creating measurable data observations (e.g., how is "one day" measured, or what defines "studying")
  - Iterative nature of between collection & analysis, and within
  - Technological limitations based on the epistemological questions
* Data Ethics
  - Practice with the ethical and legal responsibilities of those collecting, storing, and analyzing data
  - Decision making around personal privacy
  - Deliberation on the trade-offs between research results and privacy.
